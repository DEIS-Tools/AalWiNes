...
namespace mpls2pda {
    ...
    private:
        static void router_parse_adjacency(Router& router, std::istream& data, std::vector<std::unique_ptr<Router>>&routers, ptrie::map<Router*>& mapping, std::vector<const Interface*>&, std::ostream& warnings);
