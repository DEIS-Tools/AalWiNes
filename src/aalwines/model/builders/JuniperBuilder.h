...
namespace aalwines {
    ...
    private:
        using indirmap_t = ptrie::map<char, std::pair<std::string, std::string>>;
        ...
        static RoutingTable parse_table(rapidxml::xml_node<char>* node, indirmap_t& indirect, Router* parent, std::vector<const Interface*>& , std::ostream& warnings, bool skip_pfe);
